    ...
    return (
        <section className="space-y-6">
            ...
            >
                ...
                >
                    <div className="absolute inset-0 bg-blue-500 rounded-3xl blur-2xl opacity-10 group-hover:opacity-30 transition-opacity" />
                ...
                <div className="space-y-4 flex-1">
                    <h1 className="text-4xl font-bold tracking-tight">
                        Hi, I'm <span className="text-blue-500">Anjany.</span>
                    </h1>
                    <div className="space-y-2 text-muted text-lg leading-relaxed">
                        ...
                        <p>
                            Full Stack Web Developer & Software Engineer. I build scalable, AI-driven
                            systems and high-performance web applications.
                        </p>
                        <p>
                            Currently building <span className="text-foreground font-medium italic underline decoration-border underline-offset-4 transition-colors">SuperDesign</span>
                        </p>
                    </div>
                </div>
            </motion.div>
            ...
            >
                {["TypeScript", "Go-Lang", "Next.js", "React", "Node.js", "PostgreSQL", "AWS", "Docker"].map((tech) => (
                    <span
                        key={tech}
